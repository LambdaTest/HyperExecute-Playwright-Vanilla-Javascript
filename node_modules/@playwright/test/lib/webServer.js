...
class WebServer {
  constructor(config, reporter) {
    ...
    this._isAvailable = getIsAvailableFunction(config, (_reporter$onStdErr = reporter.onStdErr) === null || _reporter$onStdErr === void 0 ? void 0 : _reporter$onStdErr.bind(reporter));
  }
