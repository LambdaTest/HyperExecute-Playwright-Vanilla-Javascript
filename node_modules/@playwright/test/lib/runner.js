...
class Runner {
  ...
  async runAllTests(options = {}) {
    ...
    const result = await (0, _timeoutRunner.raceAgainstTimeout)(() => this._run(!!options.listOnly, options.filePatternFilter || [], options.projectFilter), config.globalTimeout);
    let fullResult;
