...
function createExpect(actual, messageOrOptions, isSoft, isPoll, generator) {
  return new Proxy((0, _expect.default)(actual), new ExpectMetaInfoProxyHandler(messageOrOptions, isSoft, isPoll, generator));
}
...
const customMatchers = {
  ...
  _toHaveScreenshot: _toMatchSnapshot.toHaveScreenshot
};
    ...
    return (...args) => {
      ...
      try {
        ...
        if (this._info.isPoll) {
          ...
          result = pollMatcher(matcherName, this._info.isNot, (0, _util.currentExpectTimeout)({
...
async function pollMatcher(matcherName, isNot, timeout, generator, ...args) {
  let matcherError;
  ...
  while (true) {
    ...
    try {
      let expectInstance = (0, _expect.default)(received.result);
    ...
    await new Promise(x => {
      ...
      return setTimeout(x, (_pollIntervals$shift = pollIntervals.shift()) !== null && _pollIntervals$shift !== void 0 ? _pollIntervals$shift : 1000);
    });
  }
...
_expect.default.extend(customMatchers);